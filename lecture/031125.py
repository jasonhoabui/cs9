...
find the successor, remove it, and replace currentNode with successor's data/payload
'''
...
BST8.put(7, "seven")
BST8.put(12, "twelve")
BST8.put(17, "seventeen")
assert BST8.inOrder(BST8.root) == "3 5 7 10 12 15 17 "
BST8.delete(10)
assert BST8.inOrder(BST8.root) == "3 5 7 12 15 17 "

BST9 = BinarySearchTree()
BST9.put(10, "ten")
BST9.put(15, "fifteen")
BST9.put(5, "five")
BST9.put(3, "three")
BST9.put(7, "seven")
BST9.put(12, "twelve")
BST9.put(17, "seventeen")
BST9.delete(15)
assert BST9.inOrder(BST9.root) == "3 5 7 10 12 17 "
BST9.delete(5)
assert BST9.inOrder(BST9.root) == "3 7 10 12 17 "